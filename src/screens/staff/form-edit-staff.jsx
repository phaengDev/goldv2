                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-sm-4 mb-2">
                                    ...
                                    <Select options={itemDit} onChange={(e) => handleChange('district_id_fk', e.value)} value={itemDit.find(obj => obj.value === inputs.district_id_fk)}  block placeholder="ເລືອກເມືອງ" required />
                                </div>
                                <div className="col-sm-4 mb-2">
